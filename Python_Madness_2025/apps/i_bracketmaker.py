...
pfs = LRF.predict(r1p[xcol]) + [random.randint(-10, 6) for _ in range(32)]
...
pfs = LRF.predict(BBstats[xcol]) + [random.randint(-10, 6) for _ in range(16)]
...
pfs = LRF.predict(BBstats[xcol]) + [random.randint(-10, 6) for _ in range(8)]
pus = RFU.predict(BBstats[xcol])  
for x in range(49,57):
...
pfs = LRF.predict(BBstats[xcol]) + [random.randint(-10, 6) for _ in range(4)]
pus = RFU.predict(BBstats[xcol])  
for x in range(57,61):
...
pfs = LRF.predict(BBstats[xcol]) + [random.randint(-10, 6) for _ in range(2)]
pus = RFU.predict(BBstats[xcol])  
for x in range(61,63):
...
pfs = LRF.predict(BBstats[xcol]) + random.randint(-10, 6)
pus = RFU.predict(BBstats[xcol])  
for x in range(63,64):
